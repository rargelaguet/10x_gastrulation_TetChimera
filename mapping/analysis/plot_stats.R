...
source("/Users/ricard/10x_gastrulation_TetChimera/mapping/plot/plot_settings.R")
...
io <- list()
# io$sample_metadata <- "/Users/ricard/data/10x_gastrulation_TetChimera/sample_metadata.txt"

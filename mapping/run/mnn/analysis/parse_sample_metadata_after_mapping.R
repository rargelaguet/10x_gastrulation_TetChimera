...
io$mapping <- "/Users/ricard/data/10x_gastrulation_TetChimera/results/second_batch/mapping/mapping10x_mnn.rds"
...
bar <- fread("/Users/ricard/data/10x_gastrulation_TetChimera/results/second_batch/mapping/leah/mapping_mnn_WT.txt.gz") %>%
...
fwrite(disagreement, "/Users/ricard/data/10x_gastrulation_TetChimera/results/second_batch/mapping/disagreement_leah_vs_ricard.txt.gz")

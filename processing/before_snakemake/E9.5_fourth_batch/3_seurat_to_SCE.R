...
# Define I/O
# io$seurat <- "/Users/ricard/data/10x_gastrulation_TetChimera/processed/fourth_batch/seurat.rds"
# io$outfile <- "/Users/ricard/data/10x_gastrulation_TetChimera/processed/fourth_batch/SingleCellExperiment.rds"

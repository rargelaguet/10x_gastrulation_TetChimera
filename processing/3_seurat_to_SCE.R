...
# Define I/O
# io$srat <- "/Users/ricard/data/10x_gastrulation_TetChimera/processed/first_batch/srat.rds"
io$outfile <- io$sce

# io$srat <- "/hps/nobackup2/research/stegle/users/ricard/10x_gastrulation_TetChimera/processed/first_batch/srat.rds"

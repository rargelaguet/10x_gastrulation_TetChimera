...
if (grepl("ricard",Sys.info()['nodename'])) {
  ...
  io$script <- "/Users/ricard/10x_gastrulation_TetChimera/dimensionality_reduction/automated/dimensionality_reduction_sce.R"
} else {
  source("/homes/ricard/gastrulation_multiome_10x/settings.R")
  io$script <- "/homes/ricard/10x_gastrulation_TetChimera/dimensionality_reduction/automated/dimensionality_reduction_sce.R"
...
opts$vars.to.regress <- c("nFeature_RNA")
...
###########################################################
## Run one class at a time (no batch correction applied) ##
###########################################################

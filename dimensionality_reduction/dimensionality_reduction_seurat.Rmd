...
sample_metadata <- fread("/Users/ricard/data/10x_gastrulation_TetChimera/processed/fourth_batch/metadata.txt.gz")
...
```{r}
# genes.to.plot <- rownames(seurat)[grep("Hba-|Hbb-",rownames(seurat))]
genes.to.plot <- "Hbb-y"
